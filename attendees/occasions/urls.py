...
urlpatterns = [
    ...
    path("<slug:division_slug>/<slug:assembly_slug>/participations/leaders/", view=children_ministry_participation_leader_list_view, name="children_ministry_participations_leaders"),
    path("<slug:division_slug>/<slug:assembly_slug>/participations/students/", view=children_ministry_participation_student_list_view, name="children_ministry_participations_students"),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='occasions.Group')),
        ...
        migrations.AddConstraint(
            model_name='session',
            constraint=models.UniqueConstraint(fields=('group_id', 'site_type_id', 'site_id', 'start'), name='uniq_group_location_time'),
        ),
    ]
